...
@SpringBootTest
public class TradePileRequestTest extends FutRequestBaseTest {

    @InjectMocks
    private TradePileRequest tradePileRequest;
    ...
    public void setUp() {
        ...
        tradePileRequest.setBaseAppVersion(AppVersion.WebApp);
        tradePileRequest.setBasePlatform(Platform.XboxOne);
        setupMocks();
    }
    ...
    public void testPerformRequestAsync() throws Exception {
        ...
        AuctionResponse mockResponse = MockResponseUtils.generateMockTradePile();
        ...
        AuctionResponse result = tradePileRequest.PerformRequestAsync().get();
    ...
    public void testPerformRequestAsyncNotSuccessCodeOnGet() throws Exception {
        ...
        AuctionResponse mockResponseFail = MockResponseUtils.generateMockTradePile();
